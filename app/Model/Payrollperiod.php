 ...
 */
	...
	public function beforeSave($options = array()){
		$this->data['Payrollperiod']['period'] = date('F j, Y', strtotime($this->data['Payrollperiod']['fromDate'])) . ' - ' . date('F j, Y', strtotime($this->data['Payrollperiod']['untilDAte']));
