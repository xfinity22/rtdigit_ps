	...
	public function add() {
		if ($this->request->is('post')) {
			...
			if ($this->Userstatus->save($this->request->data)) {
				$this->Session->setFlash(__('The userstatus has been saved.'));
				return $this->redirect(array('action' => 'index'));
			} else {
				$this->Session->setFlash(__('The userstatus could not be saved. Please, try again.'));
			}
		}
	}
 ...
 */
	public function delete($id = null) {
		...
		if ($this->Userstatus->delete()) {
			$this->Session->setFlash(__('The userstatus has been deleted.'));
		} else {
			$this->Session->setFlash(__('The userstatus could not be deleted. Please, try again.'));
		}
		return $this->redirect(array('action' => 'index'));
	}
}
