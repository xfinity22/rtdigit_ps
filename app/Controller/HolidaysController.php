 ...
 */
	...
	public function searchholiday($datefrom = null, $dateend = null){
		$holidays = $this->Holiday->find('all', array('conditions' => array(
			'AND' => array(
				'Holiday.date >=' => $datefrom,
				'Holiday.date <=' => $dateend
			)
		)));
