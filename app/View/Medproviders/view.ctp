<div class="medproviders view">
<h2><?php echo __('Medprovider'); ?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($medprovider['Medprovider']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Name'); ?></dt>
		<dd>
			<?php echo h($medprovider['Medprovider']['name']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Amount'); ?></dt>
		<dd>
			<?php echo h($medprovider['Medprovider']['amount']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Medprovider'), array('action' => 'edit', $medprovider['Medprovider']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Medprovider'), array('action' => 'delete', $medprovider['Medprovider']['id']), array(), __('Are you sure you want to delete # %s?', $medprovider['Medprovider']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('List Medproviders'), array('action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New Medprovider'), array('action' => 'add')); ?> </li>
		<li><?php echo $this->Html->link(__('List Employees'), array('controller' => 'employees', 'action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New Employee'), array('controller' => 'employees', 'action' => 'add')); ?> </li>
		<li><?php echo $this->Html->link(__('List Medbenefits'), array('controller' => 'medbenefits', 'action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New Medbenefit'), array('controller' => 'medbenefits', 'action' => 'add')); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($medprovider['Employee'])): ?>
	...
	<tr>
		...
		<th><?php echo __('Medprovider Id'); ?></th>
		<th><?php echo __('Plantype Id'); ?></th>
		<th class="actions"><?php echo __('Actions'); ?></th>
	</tr>
	<?php foreach ($medprovider['Employee'] as $employee): ?>
		<tr>
			...
			<td><?php echo $employee['medprovider_id']; ?></td>
			<td><?php echo $employee['plantype_id']; ?></td>
			<td class="actions">
...
<div class="related">
	<h3><?php echo __('Related Medbenefits'); ?></h3>
	<?php if (!empty($medprovider['Medbenefit'])): ?>
	<table cellpadding = "0" cellspacing = "0">
	<tr>
		<th><?php echo __('Id'); ?></th>
		<th><?php echo __('Medprovider Id'); ?></th>
	...
	<?php foreach ($medprovider['Medbenefit'] as $medbenefit): ?>
		<tr>
			<td><?php echo $medbenefit['id']; ?></td>
			<td><?php echo $medbenefit['medprovider_id']; ?></td>
			<td><?php echo $medbenefit['name']; ?></td>
			<td><?php echo $medbenefit['amount']; ?></td>
			<td class="actions">
				<?php echo $this->Html->link(__('View'), array('controller' => 'medbenefits', 'action' => 'view', $medbenefit['id'])); ?>
				<?php echo $this->Html->link(__('Edit'), array('controller' => 'medbenefits', 'action' => 'edit', $medbenefit['id'])); ?>
				<?php echo $this->Form->postLink(__('Delete'), array('controller' => 'medbenefits', 'action' => 'delete', $medbenefit['id']), array(), __('Are you sure you want to delete # %s?', $medbenefit['id'])); ?>
			</td>
		</tr>
	<?php endforeach; ?>
	</table>
...
<div class="related">
	<h3><?php echo __('Related Medhospitals'); ?></h3>
	<?php if (!empty($medprovider['Medhospital'])): ?>
	<table cellpadding = "0" cellspacing = "0">
	<tr>
		<th><?php echo __('Id'); ?></th>
		<th><?php echo __('Name'); ?></th>
	...
	<?php foreach ($medprovider['Medhospital'] as $medhospital): ?>
		<tr>
			<td><?php echo $medhospital['id']; ?></td>
			<td><?php echo $medhospital['name']; ?></td>
			<td><?php echo $medhospital['medprovider_id']; ?></td>
			<td class="actions">
				<?php echo $this->Html->link(__('View'), array('controller' => 'medhospitals', 'action' => 'view', $medhospital['id'])); ?>
				<?php echo $this->Html->link(__('Edit'), array('controller' => 'medhospitals', 'action' => 'edit', $medhospital['id'])); ?>
				<?php echo $this->Form->postLink(__('Delete'), array('controller' => 'medhospitals', 'action' => 'delete', $medhospital['id']), array(), __('Are you sure you want to delete # %s?', $medhospital['id'])); ?>
			</td>
		</tr>
	<?php endforeach; ?>
	</table>
