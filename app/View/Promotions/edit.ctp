				...
				<div id="tabs-1">
					<table class="form">
						...
						<tr>
							...
							<td>
								<?php
									echo '<input type="date" name="data[Promotion][datefrom]" value="'.$promotion['Promotion']['datefrom'].'"/>';	?>
							</td>
						</tr>
						<tr>
							<td>To</td>
							<td>
								<?php
									echo '<input type="date" name="data[Promotion][dateend]" value="'.$promotion['Promotion']['dateend'].'"/>';	?>
							</td>
						</tr>
						<tr>
						<tr>
