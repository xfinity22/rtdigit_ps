...
<?php if(!$type): ?>
<?php echo $this->element('page_back', ['controller' => 'incomes', 'action' => 'index']); ?>
<?php echo $this->element('page_title', ['title' => 'Payslip Data']); ?>
<div class="btngroup">

<?php echo $this->Html->link(__('Print'), 
	['action' => 'printpayslip', $action, $employeeid, $payrollperiod, "print"], 
	['escape' => false, 'class' => 'text-black nounderline', 'target' => '_blank']);
?>
