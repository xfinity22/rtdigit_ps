...
<h2><?php echo __('Costcenter'); ?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($costcenter['Costcenter']['id']); ?>
			&nbsp;
		</dd>
...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Costcenter'), array('action' => 'edit', $costcenter['Costcenter']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Costcenter'), array('action' => 'delete', $costcenter['Costcenter']['id']), array(), __('Are you sure you want to delete # %s?', $costcenter['Costcenter']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('List Costcenters'), array('action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New Costcenter'), array('action' => 'add')); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($costcenter['Employee'])): ?>
	...
	<?php foreach ($costcenter['Employee'] as $employee): ?>
		<tr>
