...
<?php echo $this->Form->create('Vltype'); ?>
	<fieldset>
		<legend><?php echo __('Edit Vltype'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Vltype.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Vltype.id'))); ?></li>
