...
<?php echo $this->Form->create('Employeecontactinfo'); ?>
	<fieldset>
		<legend><?php echo __('Edit Employeecontactinfo'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Employeecontactinfo.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Employeecontactinfo.id'))); ?></li>
