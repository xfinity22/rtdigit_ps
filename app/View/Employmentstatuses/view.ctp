<div class="employmentstatuses view">
<h2><?php echo __('Employmentstatus'); ?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($employmentstatus['Employmentstatus']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Name'); ?></dt>
		<dd>
			<?php echo h($employmentstatus['Employmentstatus']['name']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Employmentstatus'), array('action' => 'edit', $employmentstatus['Employmentstatus']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Employmentstatus'), array('action' => 'delete', $employmentstatus['Employmentstatus']['id']), array(), __('Are you sure you want to delete # %s?', $employmentstatus['Employmentstatus']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('List Employmentstatuses'), array('action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New Employmentstatus'), array('action' => 'add')); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($employmentstatus['Employee'])): ?>
	...
	<?php foreach ($employmentstatus['Employee'] as $employee): ?>
		<tr>
