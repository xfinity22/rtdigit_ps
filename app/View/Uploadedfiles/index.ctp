<div class="uploadedfiles index">
	<h2><?php echo __('Uploadedfiles'); ?></h2>
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('dateuploaded'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($uploadedfile['Uploadedfile']['filename']); ?>&nbsp;</td>
		<td><?php echo h($uploadedfile['Uploadedfile']['dateuploaded']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $uploadedfile['Uploadedfile']['id']), array(), __('Are you sure you want to delete # %s?', $uploadedfile['Uploadedfile']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
